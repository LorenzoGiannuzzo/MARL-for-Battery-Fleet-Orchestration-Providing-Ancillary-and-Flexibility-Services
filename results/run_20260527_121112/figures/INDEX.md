...
- Train distribution (PPO pretraining + retraining): **normal**
- Eval distributions (MILP and trained PPO benchmarked on each): **fixed-bias, normal, ornstein-uhlenbeck, uniform**
- Primary distribution for the representative-day plot: **normal**
