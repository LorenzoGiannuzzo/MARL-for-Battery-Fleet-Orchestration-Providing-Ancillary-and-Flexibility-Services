...
Generated 2026-08-05 22:36. Profits in M EUR over the held-out window, mean ± sample standard deviation across seeds.

| Config | Init | LR | Entropy | KL anchor | Profit argmax [M EUR] | Profit sampled [M EUR] | Share of MILP | n |
|---|---|---|---|---|---|---|---|---|
| Discrete MILP benchmark | – | – | – | – | 11.64 | – | 1.000 | 1 |
| Behavioural clone (no RL) | – | – | – | – | 11.49 | – | 0.987 | 1 |
| PPO warm start (full) | BC | 0.1x | 0 | yes | 10.87 | 9.46 | 0.934 | 1 |
