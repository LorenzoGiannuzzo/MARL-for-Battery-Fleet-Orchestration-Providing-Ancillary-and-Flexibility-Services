...
Why it exists
-------------
The pipeline (pipeline_step8.generate_multi_day_expert_demos) evaluates the
...
Action-axis mapping (directional 7-axis, matching multi_bess_env and
bc_pretraining_multi._discretise_milp_action_directional):
...
from multi_bess_env import N_ACTION_BINS
...
def build_discrete_oracle(
    ...
    *,
    ...
    `multi_bess_env._decode_clip_actions`, so the discrete MILP plans in the
